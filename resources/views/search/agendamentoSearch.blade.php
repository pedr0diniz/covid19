<form>
  ...
  <div class="form-group row">
    ...
    <div class="form-group row">
      <label for="intervaloAgendamento1" class="col-sm-3 col-form-label">Agendamento(s) entre o(s) dia(s):</label>
      <div class="col-sm-3">
        <input type="date" class="form-control" id="intervaloAgendamento1">
      </div>
      <label for="intervaloAgendamento2" class="col-sm-1 col-form-label"> e:</label>
      <div class="col-sm-3">
        <input type="date" class="form-control" id="intervaloAgendamento2">
      </div>       
    </div>
