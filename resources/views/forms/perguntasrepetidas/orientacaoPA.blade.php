    ...
    <div class="row">
        ...
        <div class="col-sm-8">
            <div class="form-check">
                <input class="form-check-input" type="radio" name="orientaPA" id="orientadoPA" value="opcao1">
                <label class="form-check-label" for="orientadoPA">
                    Sim
                </label>
            </div>
            <div class="form-check">
                <input class="form-check-input" type="radio" name="orientaPA" id="naoOrientadoPA" value="opcao2">
